...
const mapDispatchToProps = (dispatcher) => bindActionCreators({ getForecastCity }, dispatcher);

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ForecastCity));
